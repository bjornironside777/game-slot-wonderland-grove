...
export default class GameService extends EventEmitter implements ICommonGameService {
    ...
    public async initialize(): Promise<[Wallet, SlotMachine]> {
        ...
        const description: SlotMachineDescription = {
            ...
            symbols: [ 25, 105, 104, 103, 102, 101, 204, 203, 202, 201, 205, 206, 207, 208, 106, 107, 108, 109, 110],
            ...
            reels: {
                regular: {
                    ...
                    reels: [
                        {
                            numRows: 4,
                            availableSymbols: [ 105, 104, 103, 102, 101, 204, 203, 202, 201, 205, 206, 207, 208, 106, 107, 108, 109, 110],
                        },
                        {
                            numRows: 4,
                            availableSymbols: [ 105, 104, 103, 102, 101, 204, 203, 202, 201, 205, 206, 207, 208, 106, 107, 108, 109, 110],
